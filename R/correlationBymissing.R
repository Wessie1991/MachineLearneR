...
#' @description This function is used internally inside the function; eliminateHighestMissingVariableInCorrelationCutoff to find the NA values per variable
